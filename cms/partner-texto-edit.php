...
if($proceso == ""){
  ...
  $filaInt = mysqli_fetch_array($ejecutarPartner);
...
if($proceso=="Actualizar"){
  ...
  header("Location:partner-texto.php");
}
?>
<!DOCTYPE html>
<html lang="es">
  <head>
    ...
    <script>
      function Validar(){
        ...
        document.fcms.action = "partner-texto-edit.php";
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            ...
            <footer class="card-footer">
              ...
              <input type="hidden" name="cod_" value="<?php echo $cod_inteligencia; ?>">
            </footer>
