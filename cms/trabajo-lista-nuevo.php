...
if($proceso == "Registrar"){
  ...
  $insertarTrabajo = "INSERT INTO trabajo_lista(titulo, descripcion, orden, estado)VALUE('$titulo', '$descripcion', '$orden', '$estado')";
  $resultadoTrabajo = mysqli_query($enlaces,$insertarTrabajo);
  $mensaje = "<div class='alert alert-success' role='alert'>
          <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
          <strong>Nota:</strong> El enlace se registr&oacute; exitosamente. <a href='trabajo.php'>Ir a Trabajos</a>
        </div>";
}
?>
<!DOCTYPE html>
  ...
  <head>
    ...
    <script>
      function Validar(){
        ...
        document.fcms.action = "trabajo-lista-nuevo.php";
