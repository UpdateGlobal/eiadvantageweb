...
if($proceso == "Registrar"){
  ...
  $insertarProgramas = "INSERT INTO programas_lista(titulo, descripcion, orden, estado)VALUE('$titulo', '$descripcion', '$orden', '$estado')";
  $resultadoInsertar = mysqli_query($enlaces,$insertarProgramas);
  $mensaje = "<div class='alert alert-success' role='alert'>
          <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
          <strong>Nota:</strong> El enlace se registr&oacute; exitosamente. <a href='programas.php'>Ir a Programas</a>
        </div>";
}
?>
<!DOCTYPE html>
  ...
  <head>
    ...
    <script>
      function Validar(){
        ...
        document.fcms.action = "programas-lista-nuevo.php";
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            ...
            <footer class="card-footer">
              ...
              <button class="btn btn-bold btn-primary" type="button" name="boton" onClick="javascript:Validar();" /><i class="fa fa-chevron-circle-right"></i> Registrar P&aacute;rrafo</button>
