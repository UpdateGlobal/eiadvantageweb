        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-bordered">
              ...
              <div class="card-body">
                <a class="btn btn-info" href="<?php if($xVisitante=="0"){ ?>noticias-categorias-nuevo.php<?php }else{ ?>javascript:visitante();<?php } ?>"><i class="fa fa-plus"></i> A&ntilde;adir nueva</a>
                <hr>
                <form name="fcms" method="post" action="">
                  <table class="table">
                    <thead>
                      <tr>
                        <th width="55%" scope="col">Categor&iacute;a
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php if($xCodigo!="0"){?><a class="boton-editar" href="noticias-categorias-editar.php?cod_categoria=<?php echo $xCodigo; ?>"><i class="fa fa-pencil-square"></i></a><?php }?></td>
