              ...
              <div class="card-body">
                ...
                <form name="fcms" method="post" action="">
                  <table class="table" data-provide="datatables">
                    ...
                    <tbody>
                      <?php
                        $consultarNoticias = "SELECT cn.cod_categoria, cn.categoria, n.* FROM noticias_categorias as cn, noticias as n WHERE cn.cod_categoria=n.cod_categoria ORDER BY orden ASC";
