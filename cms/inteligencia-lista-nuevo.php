...
if($proceso == "Registrar"){
  ...
  $insertarInteligencia = "INSERT INTO inteligencia_lista(titulo, descripcion, link, orden, estado)VALUE('$titulo', '$descripcion', '$link', '$orden', '$estado')";
  $resultadoInsertar = mysqli_query($enlaces,$insertarInteligencia);
  $mensaje = "<div class='alert alert-success' role='alert'>
          <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
          <strong>Nota:</strong> El enlace se registr&oacute; exitosamente. <a href='inteligencia.php'>Ir a Inteligencia Emocional</a>
        </div>";
}
?>
<!DOCTYPE html>
  ...
  <head>
    ...
    <script>
      function Validar(){
        ...
        if(document.fcms.link.value==""){
          alert("Debe escribir un enlace");
          document.fcms.link.focus();
          return;
        }
        document.fcms.action = "inteligencia-lista-nuevo.php";
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label class="col-form-label required" for="link">Enlace:</label>
                </div>
                <div class="col-8 col-lg-10">
            ...
            <footer class="card-footer">
              ...
              <button class="btn btn-bold btn-primary" type="button" name="boton" onClick="javascript:Validar();" /><i class="fa fa-chevron-circle-right"></i> Registrar Enlace</button>
