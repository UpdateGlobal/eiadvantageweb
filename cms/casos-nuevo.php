...
if($proceso == "Registrar"){
  ...
  $insertarCasos = "INSERT INTO casos(slug, titulo, imagen, resumen, descripcion, fecha, estado)VALUE('$slug', '$titulo', '$imagen', '$resumen', '$descripcion', '$fecha', '$estado')";
  $resultadoInsertar = mysqli_query($enlaces,$insertarCasos);
  $mensaje = "<div class='alert alert-success' role='alert'>
          <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
          <strong>Nota:</strong> El caso se registr&oacute; exitosamente. <a href='casos.php'>Ir a Casos de Estudio</a>
        </div>";
}
?>
<!DOCTYPE html>
  ...
  <head>
    ...
    <script>
      function Validar(){
        ...
        document.fcms.action = "casos-nuevo.php";
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-8 col-lg-10">
                  <textarea data-provide="summernote" data-toolbar="full" id="resumen" name="resumen" data-min-height="150"></textarea>
                </div>
              </div>
            ...
            <footer class="card-footer">
              ...
              <button class="btn btn-bold btn-primary" type="button" name="boton" onClick="javascript:Validar();" /><i class="fa fa-chevron-circle-right"></i> Registrar Caso</button>
              <?php
                $fecha = date("Y-m-d");
              ?>
