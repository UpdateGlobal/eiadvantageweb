...
// Subir Evaluaciones
if($id=='EVA'){
	$uploaddir = 'assets/img/evaluaciones/'.$uploadname;
	if(move_uploaded_file($uploadtempname, $uploaddir)){
		$mensaje = "El archivo subi&oacute; correctamente";
	}else{
		$mensaje = "El archivo no se subi&oacute;";
...
// Subir Imagen Contenidos
if($id=='CON'){
	$uploaddir = 'assets/img/contenidos/'.$uploadname;
	if(move_uploaded_file($uploadtempname, $uploaddir)){
		$mensaje = "El archivo subi&oacute; correctamente";
	}else{
		$mensaje = "El archivo no se subi&oacute;";  
...
// Subir 
if($id=='CAS'){
	$uploaddir = 'assets/img/casos/'.$uploadname;
	if(move_uploaded_file($uploadtempname, $uploaddir)){
		$mensaje = "El archivo subi&oacute; correctamente";
	}else{
		$mensaje = "El archivo no se subi&oacute;";  
...
<script>
	function Cerrar(){
		...
		if(tNavegador=="Netscape"){
			...
			if(valor=="FT") {
				window.opener.document.fcms.ficha_tecnica.value = "<?php echo basename($_FILES['imagen']['name']); ?>";
			}
			if(valor=="BG") {
				window.opener.document.fcms.banner_grande.value = "<?php echo basename($_FILES['imagen']['name']); ?>";
			}
			if(valor=="BC") {
				window.opener.document.fcms.banner_chico.value = "<?php echo basename($_FILES['imagen']['name']); ?>";
			}
			if(valor=="EVA") {
				window.opener.document.fcms.imagen.value = "<?php echo basename($_FILES['imagen']['name']); ?>";
			}
			...
			if(valor=="LOGO") {
				window.opener.document.fcms.logo.value = "<?php echo basename($_FILES['imagen']['name']); ?>";
			}
			if(valor=="FIA") {
				window.opener.document.fcms.face1.value = "<?php echo basename($_FILES['imagen']['name']); ?>";
			}
			if(valor=="FIB") {
				window.opener.document.fcms.face2.value = "<?php echo basename($_FILES['imagen']['name']); ?>";
			}
			if(valor=="ICO") {
				window.opener.document.fcms.ico.value = "<?php echo basename($_FILES['imagen']['name']); ?>";
			}
			if(valor=="USU") {
				window.opener.document.fcms.imagen.value = "<?php echo basename($_FILES['imagen']['name']); ?>";
			}
			if(valor=="NOS") {
				window.opener.document.fcms.img_contenido.value = "<?php echo basename($_FILES['imagen']['name']); ?>";
			}
			if(valor=="CON") {
				window.opener.document.fcms.imagen.value = "<?php echo basename($_FILES['imagen']['name']); ?>";
			}
