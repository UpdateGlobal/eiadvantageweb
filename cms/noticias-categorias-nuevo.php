...
if($proceso == "Registrar"){
  ...
  $insertarCategorias = "INSERT INTO noticias_categorias(categoria, slug, orden, estado)VALUE('$categoria', '$slug', '$orden', '$estado')";
  $resultadoInsertar = mysqli_query($enlaces,$insertarCategorias);
  $mensaje = "<div class='alert alert-success' role='alert'>
          <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
          <strong>Nota:</strong> Categor&iacute;a registrada con &eacute;xito <a href='noticias-categorias.php'>Ir a Categor&iacute;as</a>
        </div>";
}
?>
<!DOCTYPE html>
  ...
  <body>
    ...
    <main>
      ...
      <div class="main-content">
        <div class="card">
          <h4 class="card-title"><strong>Categor&iacute;a Nueva</strong></h4>
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            ...
            <footer class="card-footer">
              ...
              <button class="btn btn-bold btn-primary" type="button" name="boton" onClick="javascript:Validar();" /><i class="fa fa-chevron-circle-right"></i> Registrar Categor&iacute;a</button>
