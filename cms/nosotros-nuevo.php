...
if($proceso == "Registrar"){
  ...
  $insertarNosotros = "INSERT INTO nosotros(titulo, slug, texto_menu, descripcion, contacto, orden, estado)VALUE('$titulo', '$slug', '$texto_menu', '$descripcion', '$contacto', '$orden', '$estado')";
  ...
  <head>
    ...
    <script type="text/javascript">
      function Validar(){
        ...
        document.fcms.action = "nosotros-nuevo.php";
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-8 col-lg-10">
                  <input class="form-control" name="texto_menu" type="text" id="texto_menu" required />
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-8 col-lg-10">
                  <textarea class="form-control" name="descripcion" data-toolbar="full" id="descripcion" data-provide="summernote" data-min-height="150"></textarea>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-2 col-lg-10">
                  <input type="checkbox" id="contacto" name="contacto" data-size="small" data-provide="switchery" value="1">
                </div>
              </div>
            ...
            <footer class="card-footer">
              ...
              <button class="btn btn-bold btn-primary" type="button" name="boton" onClick="javascript:Validar();" /><i class="fa fa-chevron-circle-right"></i> Registrar Secci&oacute;n</button>
