...
if($proceso == "Registrar"){
  ...
  $insertarInteligencia = "INSERT INTO certificaciones_lista(titulo, descripcion, orden, estado)VALUE('$titulo', '$descripcion', '$orden', '$estado')";
  $resultadoInsertar = mysqli_query($enlaces,$insertarInteligencia);
  $mensaje = "<div class='alert alert-success' role='alert'>
          <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
          <strong>Nota:</strong> El p&aacute;rrafo se registr&oacute; exitosamente. <a href='certificaciones-principal.php'>Ir a Certificaciones</a>
        </div>";
}
?>
<!DOCTYPE html>
  ...
  <head>
    ...
    <script>
      function Validar(){
        ...
        document.fcms.action = "certificaciones-lista-nuevo.php";
