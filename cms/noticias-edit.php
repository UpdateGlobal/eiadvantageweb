...
if($proceso == ""){
  ...
  $titulo         = htmlspecialchars_decode($filaNot['titulo']);
  $subtitulo      = htmlspecialchars_decode($filaNot['subtitulo']);
  $noticia        = htmlspecialchars_decode($filaNot['noticia']);
...
if($proceso=="Actualizar"){ 
  ...
  $actualizarNoticias = "UPDATE noticias SET cod_noticia='$cod_noticia', cod_categoria='$cod_categoria', titulo='$titulo', subtitulo='$subtitulo', slug='$slug', noticia='$noticia', imagen='$imagen', estado='$estado' WHERE cod_noticia='$cod_noticia'";
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-8 col-lg-10">
                  <input class="form-control" name="subtitulo" type="text" id="subtitulo" value="<?php echo $subtitulo; ?>" />
                  <div class="invalid-feedback"></div>
                </div>
              </div>
