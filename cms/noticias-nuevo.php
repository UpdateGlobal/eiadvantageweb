...
if($proceso == "Registrar"){
  ...
  $insertarNoticia = "INSERT INTO noticias(cod_categoria, slug, titulo, subtitulo, imagen, noticia, fecha, estado)VALUE('$categoria', '$slug', '$titulo', '$subtitulo', '$imagen', '$noticia', '$fecha', '$estado')";
  $resultadoInsertar = mysqli_query($enlaces,$insertarNoticia);
  $mensaje = "<div class='alert alert-success' role='alert'>
          <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
          <strong>Nota:</strong> La publicaci&oacute;n se registr&oacute; con exitosamente. <a href='noticias.php'>Ir a noticias</a>
        </div>";
}
?>
<!DOCTYPE html>
  ...
  <head>
    ...
    <script>
      function Validar(){
        ...
        if(document.fcms.noticia.value==""){
          alert("Debe escribir una noticia");
          document.fcms.noticia.focus();
          return;
        }
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label class="col-form-label" for="subtitulo">Sub-T&iacute;tulo:</label>
                </div>
                <div class="col-8 col-lg-10">
                  <input class="form-control" name="subtitulo" type="text" id="subtitulo" />
                  <div class="invalid-feedback"></div>
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label class="col-form-label" for="noticia">Texto:</label>
                </div>
                <div class="col-8 col-lg-10">
            ...
            <footer class="card-footer">
              ...
              <button class="btn btn-bold btn-primary" type="button" name="boton" onClick="javascript:Validar();" /><i class="fa fa-chevron-circle-right"></i> Registrar Noticia</button>
              <?php
                $fecha = date("Y-m-d");
              ?>
