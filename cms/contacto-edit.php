...
if($proceso == "Actualizar"){
  ...
  $ActualizarContact = "UPDATE contacto SET cod_contact='$cod_contact', direction='$direction', phone='$phone', mobile='$mobile', email='$email', form_mail='$formem' WHERE cod_contact='$cod_contact'";
