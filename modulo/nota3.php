<div class="container fluiz container">
	<div class="row"><br><br>
		...
		<div class="col-sm-12">
			<h3>INCREMENTO DEL COMPROMISO DE LOS TRABAJADORES Y LA INTELIGENCIA EMOCIONAL DE LOS LÍDERES CON IBM</h3>
			<img src="http://via.placeholder.com/1110x280" class="img-responsive" style="width: auto;">
				<br>	
		
			<h5>Resumen</h5>
			<p class="lead text-justify">
				Genos International viene trabajando con IBM bajo un criterio de largo plazo y está constantemente comprometido en desarrollar programas de vanguardia que se enfocan en desarrollar habilidades a través de toda la estructura gerencial. Hasta la fecha, todo nuestro trabajo con IBM se ha concentrado en utilizar nuestras evaluaciones y programas de inteligencia emocional para afinar competencias de mentoring y enseñanza. Este estudio de caso se enfoca en un proyecto de investigación que Genos desarrolló con IBM para determinar la correlación entre los niveles de inteligencia emocional de los líderes de IBM y el compromiso que resultó de sus reportes directos.<br>
				...
				<p class="lead text-justify">Genos evaluó la inteligencia emocional de 200 líderes dentro del marco de IBM, usando el modelo 360º de Inteligencia Emocional. Luego calculamos la puntuación promedio de inteligencia emocional a través de las calificaciones emitidas por los demás. Genos también evaluó a los 438 reportes directos que trabajaban con estos 200 líderes. Esta evaluación se realizó usando la Encuesta Genos de Compromiso de los Trabajadores, que usamos para calcular el compromiso psicológico y emocional de cada persona con IBM. Calculamos analíticamente los resultados invitando a los encuestados que indiquen en qué medida demostraban las cuatro conductas indicadas en el siguiente gráfico:
				Elogiar</p>
				...
				<ul class="lead" style="padding-left: 70px;">
					...
					<li>Cada vez que puedo, digo a los demás lo bueno que es trabajar en esta organización.</li>
					<li>Promociono a esta organización como un buen lugar de trabajo.</li>
				</ul>
				<h3>Persistir</h3>
				<ul class="lead" style="padding-left: 70px;">
					<li>Mi compromiso con esta organización es incondicional, incluso cuando las cosas se ponen difíciles.</li>
					<li>Nunca pienso en dejar esta organización, incluso si me ofrecen otras oportunidades.</li>
				</ul>
				<h3>Cumplir</h3>
				<ul class="lead" style="padding-left: 70px;">
					
					<li>Hago con gusto mucho más de lo que se espera de mí en el trabajo.</li>
					<li>Lo que siento por esta organización me motiva a hacer todo lo posible para que tenga éxito.</li>
				</ul>
				<h3>Perfeccionar</h3>
				<ul class="lead" style="padding-left: 70px;">
					
					<li>Continuamente trato de mejorar mi forma de hacer las cosas en esta organización.</li>
					<li>Me motiva buscar formas nuevas e innovadoras de hacer las cosas en esta organización.</li>
				</ul>
