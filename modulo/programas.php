<div class="container container-fluid " style="padding-left: 30px;">
	...
	<div class="row">
		<div class="col-md 12">
				...
				<p class="lead text-justify">Cada uno de nuestros programas de inteligencia emocional se diseñaron para mejorar, incrementar y fortalecer el compromiso de los trabajadores y la productividad, generando mayores ingresos y el éxito de la organización.</p>
				...
				<p class="lead text-justify">El programa de un día es una manera ideal de presentar a sus colaboradores los beneficios y usos de la consciencia emocional de sí mismos y puede ser el punto de partida perfecto para desarrollos subsiguientes a lo largo y ancho de su organización.
				</p>
		</div>
	</div>
	<br><br>
