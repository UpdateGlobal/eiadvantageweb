				...
				<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
					...
					<article class="post">
						<div class="media-wrapper">
							<a href="post.php?cod_noticia=<?php echo $xCodigo; ?>"><img src="cms/assets/img/noticias/<?php echo $xImagen; ?>" class="img-responsive" alt=""></a>
						</div>
						<h4><a href="post.php?cod_noticia=<?php echo $xCodigo; ?>"><?php echo $xTitulo; ?></a></h4>
	                    ...
	                    ?></p>
						<p><a href="post.php?cod_noticia=<?php echo $xCodigo; ?>" class="btn btn-primary">Leer Mas</a></p>
					</article>
					<!-- End post 1 -->
					<?php 
						}
