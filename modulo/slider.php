			...
			<ul> 
				<li data-transition="slideremoveright">
					...
					<div class="tp-caption cap-boxed secondary-bg" 
						...
						style="z-index: 5; white-space: nowrap;">Tomar Mejores<strong> Decisiones</strong>
					</div>
					...
					<div class="tp-caption cap-boxed capUppercase-title" 
						...
						data-splitout="none" 
						data-responsive_offset="on" 
						style="z-index: 5; white-space: normal; margin: 40px 0px 0px;">Inteligencia Emocional en el Trabajo
					</div>
			...
			<!-- data-lineheight="['42','32','24','14']" -->  
				...
				<li data-transition="slideremoveright">
					...
					<div class="tp-caption cap-boxed capUppercase-title" 
						...
						data-splitout="none" 
						data-responsive_offset="on" 
						style="z-index: 5; white-space: nowrap;">Generar Compromiso<strong> de su Gente</strong> 
					</div>
				...
				<li data-transition="slideremoveright">
					...
					<div class="tp-caption cap-boxed capUppercase-title" 
						...
						data-splitout="none" 
						data-responsive_offset="on" 
						style="z-index: 5; white-space: nowrap;">Promover Alto Desempeño y<strong> Resultados Óptimos</strong> 
					</div>
