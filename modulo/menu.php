				...
				<ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="aboutGenosInternacional.php">Genos International</a>
							</li>
						</ul>
					</li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="dropdown.menu">
								<a href="liderazgoEmocional.php">Modelo Genos de I.E. Liderazgo</a>
							</li>
							<li class="dropdown.menu">
								<a href="manualTecnico.php">Manual Tecnico de I.E.</a>
							</li>
							<li class="dropdown.menu">
								<a href="publicaciones.php">Publicaciónes de Investigaciónes de I.E.</a>
							</li>
